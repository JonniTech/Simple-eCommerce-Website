            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 gap-4">
                    {products.map((product) => (
                        <div key={product._id} className="bg-white dark:bg-[#362F5C] p-4 rounded-2xl shadow-sm border border-transparent dark:border-white/5 overflow-x-auto group">
                            <div className="flex gap-4 items-center min-w-max pb-2">
                                ...
                                <div className="flex-1 min-w-[200px]">
                                    ...
                                    <div className="flex items-center gap-4 mt-1 text-sm text-gray-500">
                                        ...
                                        <span className="whitespace-nowrap">Stock: {product.stock}</span>
                                        <span className="truncate max-w-[150px] opacity-60">{product.category}</span>
                                    </div>
                                </div>

                                <div className="flex items-center gap-2 pl-4 border-l border-gray-100 dark:border-white/5 ml-auto">
                                    <Link
